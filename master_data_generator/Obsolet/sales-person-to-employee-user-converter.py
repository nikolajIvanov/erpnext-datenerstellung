...
def main():
    sales_files = ['../master_data_csv/sales_directors.csv',
                   '../master_data_csv/sales_managers.csv',
                   '../master_data_csv/sales_reps.csv']
    ...
    while to_process:
        ...
        if employees:
            write_to_csv(employees, f'../Generated_CSV/employees_level_{level}.csv', employee_fields)
            write_to_csv(users, f'../Generated_CSV/users_level_{level}.csv', user_fields)
    ...
    write_to_csv(all_employees, '../Generated_CSV/all_employees.csv', employee_fields)
    write_to_csv(all_users, '../Generated_CSV/all_users.csv', user_fields)
