...
def main():
    ...
    save_to_csv(sales_directors, '../new csv/sales_directors.csv', sales_person_fields)
    save_to_csv(sales_managers, '../new csv/sales_managers.csv', sales_person_fields)
    save_to_csv(sales_reps, '../new csv/sales_reps.csv', sales_person_fields)
