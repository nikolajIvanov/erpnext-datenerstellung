...
class Config:
    ...
    RECEIPT_DELAY = (1, 14)  # Wareneingang 1-14 Tage nach BestellungRe
    INVOICE_DELAY = (0, 3)   # chnung 0-3 Tage nach Wareneingang
...
def main():
    ...
    print("Datengenerierung abgeschlossen. Ausgabedateien wurden im Verzeichnis 'generated' gespeichert.")
