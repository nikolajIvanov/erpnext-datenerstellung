...
def main():
    # Load necessary data
    companies = load_companies('../master/companies.csv')
    campaigns = load_campaigns('../master/campaigns.csv')
    sales_persons = load_sales_persons('../master/sales_directors.csv') + \
                    load_sales_persons('../master/sales_managers.csv') + \
                    load_sales_persons('../master/sales_reps.csv')
    sources = load_sources('../master/source_data.csv')
    ...
    save_to_csv(leads, '../generated/leads.csv')
