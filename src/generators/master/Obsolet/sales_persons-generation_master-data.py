...
def main():
    ...
    save_to_csv(sales_directors, '../generated/sales_directors.csv', sales_person_fields)
    save_to_csv(sales_managers, '../generated/sales_managers.csv', sales_person_fields)
    save_to_csv(sales_reps, '../generated/sales_reps.csv', sales_person_fields)
    save_to_csv(territories, '../generated/territories.csv', territory_fields)
