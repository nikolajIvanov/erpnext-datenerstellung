...
def main():
    ...
    save_to_csv(all_items, '../data/generated/items.csv')
    save_serial_numbers_to_csv(bike_serial_numbers, '../data/generated/serial_numbers.csv')
    save_batch_numbers_to_csv(component_batch_numbers, '../data/generated/batch_numbers.csv')
