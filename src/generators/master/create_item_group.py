...
def main():
    ...
    save_to_csv(top_level_group, '../data/generated/1_top_level_item_group.csv')
    save_to_csv(second_level_groups, '../data/generated/2_second_level_item_groups.csv')
    save_to_csv(third_level_groups, '../data/generated/3_third_level_item_groups.csv')
